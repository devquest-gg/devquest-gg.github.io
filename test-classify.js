...
const CASES = [
  ...
  ["3D Model, Scene, and Avatar Generation Algorithm Research Intern", "Art"],
  ["Avatar Generation Pipeline Engineer", "!Art"],
  ["AI Art Specialist - Gaming", "Art"],
  ["Art Outsourcing Manager", "Art"],
  ["Smart Data Specialist", "!Art"],
  ["Associate Tech Lead, Web Platforms", "Engineering"],
  ["Tech Art Lead", "Art"],
  ["Esport Specialist", "Esports"],
  ["e-Sports Events Coordinator", "Esports"],
  ["Esports Production Manager", "Production"],
  ["Feature Lead", "Design"],
  ["Feature Engineering Lead", "!Design"],
  ["Game Backend Development Intern", "Engineering"],
  ["Full Stack Intern", "Engineering"],
  ["Internship Gameplay Code", "Engineering"],
  ["Engine Code Intern", "Engineering"],
  ["Dress Code Coordinator", "!Engineering"],
  ["Lead Unity Game Development (Casual Games)", "Engineering"],
  ["Unity Technical Artist", "Art"],
  ["Unity Game Designer", "Design"],
  ["Network and Security Technician", "Engineering"],
  ["Networking and Security Lead", "Engineering"],
  ["IT Support Specialist", "Engineering"],
  ["Security Guard", "!Engineering"],
